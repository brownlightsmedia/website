...
const GooeyNav = ({
  ...
  // Sync state when parent activePageIndex changes (e.g. on scroll page turn)
  useEffect(() => {
  ...
  const makeParticles = element => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      setTimeout(() => {
        ...
        particle.style.setProperty('--color', `#FFFFFF`);
    ...
    <div className="gooey-nav-container" ref={containerRef}>
      <nav>
        <ul ref={navRef}>
          ...
          <li>
            <button 
              onClick={() => onOpenBooking && onOpenBooking('General Inquiry')} 
              style={{
